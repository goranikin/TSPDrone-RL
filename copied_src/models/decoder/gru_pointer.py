...
class GRUPointerDecoder(AutoregressiveDecoder):
    """Single-layer GRU with the Pointer Networks additive output attention."""
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__()
        self.cell = nn.GRUCell(d_model + context_dim, d_model)
    ...
    def step_logits(
        ...
        if self._hidden is None:
            raise RuntimeError("GRU decoder state is not initialized")
